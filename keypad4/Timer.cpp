...
int CountdownTimer::drawTimer(Adafruit_SH1106& display) {
    if (!startTime) {
...
int InputTimer::drawTimer(Adafruit_SH1106& display) {
    lastDraw = millis();
...
int Timer::drawTimer(Adafruit_SH1106& display, const char* timeText, int cursor) {
